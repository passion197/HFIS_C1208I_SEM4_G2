    ...
    <form id="main-search" method="post" action="search">
        ...
        <div class="column radios">
            ...
            <div class="f-item">
                ...
                <label for="self_catering">Tour</label>
            </div>
            <div class="f-item">
            ...
            <div class="form" id="form2">
                ...
                <div class="column">
                    ...
                    <div class="f-item">
                        <label>City</label>
                        <select name="city">
                            <option value="4">Rio de Janeiro - Brazil</option>
                ...
                <div class="column twins">
                    <h4><span>03</span> When?</h4>
                    <div class="f-item datepicker">
                        <label for="datepicker1">Tour Depart</label>
                        <div class="datepicker-wrap"><input type="text" placeholder="" id="datepicker4" name="tourDepart" /></div>
                    </div>
                    <div class="f-item datepicker">
                        <label for="datepicker2">Tour Return</label>
                        <div class="datepicker-wrap"><input type="text" placeholder="" id="datepicker5" name="tourReturn" /></div>
                    </div>
                </div>
                <!--//column-->
                ...
                <div class="column twins last">
                    <h4><span>04</span> Who?</h4>
                    <div class="f-item spinner">
                        <label for="spinner1">Traveler Amount</label>
                        <input type="text" placeholder="" id="spinner4" name="amount" />
                    </div>
                </div>
                <!--//column-->
            </div>	
