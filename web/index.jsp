<%-- 
    Document   : index
    Created on : Jun 20, 2014, 4:24:05 PM
    Author     : Doll
--%>
        ...
        <div class="main" role="main">
            <div class="wrap clearfix">
                ...
                <section class="destinations clearfix full">
                    ...
                    <s:iterator value="listTour" var="ltour">
                        <!--column-->
                        <article class="one-fourth">
                            <figure><a href="tourdetail?tourID=<s:property value="tourID"/>" title=""><img src="images/uploads/<s:property value="img"/>" alt="" width="270" height="152" /></a></figure>
                            <div class="details">
                                <a href="tourdetail?tourID=<s:property value="tourID"/>" title="View more information..." class="gradient-button">MORE INFO</a>
                                <h5><s:property value="tourName"/></h5>
                                <br/>
                                <p>Seat Available: <b><s:property value="seatAvailable"/></b></p>
                                <p>Tour Depart: <b><s:property value="tourDepart"/></b></p>
                                <div class="ribbon">
                                    <div class="half" style="margin-left: -25px">
                                        <a href="" title="Child">
                                            <span><span class="small">From: </span>
                                            <span class="price">&#36; <s:property value="costChild"/></span></span>
                                        </a>
                                    </div>
                                    <div class="half">
                                        <a href="" title="Adults">
                                            <span class="small">To</span>
                                            <span class="price">&#36; <s:property value="costAdults"/></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
